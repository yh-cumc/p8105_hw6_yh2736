...
THe 95% confidence interval for r^2 is from `r mean_r_squared - qnorm(0.05) * (sd_r_squared / sqrt(5000))` to `r mean_r_squared + qnorm(0.05) * (sd_r_squared / sqrt(5000))`.

THe 95% confidence interval for log(β^0∗β^1)  is from `r mean_log_beta0_mult_beta1 - qnorm(0.05) * (sd_log_beta0_mult_beta1 / sqrt(5000))` to `r mean_log_beta0_mult_beta1 + qnorm(0.05) * (sd_log_beta0_mult_beta1 / sqrt(5000))`.
